...
class TestWebVidCoVR:
    ...
    def __call__(self, model, data_loader, fabric):
        ...
        for ref_img, img_prompt, tar_feat, caption, pair_id, *_ in data_loader:
        ...
        ref_img_ids = [data_loader.dataset.pairid2ref[int(pair_id)] for pair_id in pair_ids]
        tar_img_ids = [data_loader.dataset.pairid2tar[int(pair_id)] for pair_id in pair_ids]
